      ...
      <View className="px-5 pt-4 pb-2">
        ...
        <View className="flex-row items-center justify-between mb-8">
          ...
          <View className="flex-row items-center gap-3">
            {/* Search Button */}
            <TouchableOpacity className="p-3 rounded-[14px] border-[1.5px] border-[#F2EEF4] bg-white items-center justify-center">
              <SearchNormal1 size={16} color="#626262" />
            </TouchableOpacity>

            {/* Notifications Button */}
            <TouchableOpacity className="w-11 h-11 rounded-[14px] border-[1.5px] border-[#F2EEF4] bg-white items-center justify-center relative">
              <Notification size={16} color="#626262" />
              {/* Notification Dot */}
              <View className="absolute top-[10px] right-[10px] w-2.5 h-2.5 bg-[#EE8B3A] rounded-full border-[1.5px] border-white" />
            </TouchableOpacity>

            {/* Profile Button */}
            <TouchableOpacity className="w-11 h-11 rounded-[14px] overflow-hidden border-[1.5px] border-[#F2EEF4] bg-[#F4F4F4] items-center justify-center">
