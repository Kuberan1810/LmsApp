...
interface ProfileScreenCardProps {
...
export default function ProfileScreenCard({ user, menuItems, onLogoutConfirm }: ProfileScreenCardProps) {
        ...
        <View className="flex-1 bg-white px-5 pt-6">
            ...
            <View className="flex-row items-center mb-8">
                {user.image ? (
                    ...
                    <View className="w-[88px] h-[88px] rounded-full mr-4 bg-[#FFF5ED] items-center justify-center">
                        <Text className="text-[#F67300] font-bold text-[32px]">
                ...
                <View>
                    <Text className="text-[24px] font-semibold text-[#333] mb-1">
                        {user.name}
                    </Text>

                    <Text className="text-[14px] text-[#808080]">
                        {user.email}
                    </Text>
                </View>
            </View>
