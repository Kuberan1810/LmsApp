...
import { ArrowLeft2, CalendarRemove, DocumentDownload, Award, Message, ArrowLeft, MessageSquare, Message2 } from 'iconsax-react-native';
                ...
                <View className="bg-white border border-[#F2EEF4] p-5 rounded-[16px] mb-5 shadow-xs">
                    <View className="flex-row items-center mb-3">
                        <TouchableOpacity onPress={onBack} className="mr-2 p-1">
                            <ArrowLeft size={20} color="#1F2937" variant="Linear" />
                        </TouchableOpacity>
